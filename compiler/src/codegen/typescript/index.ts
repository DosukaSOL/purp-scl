// ============================================================================
// Purp TypeScript Code Generator v0.3.0 — The Solana Coding Language
...
export class TypeScriptCodegen {
  ...
  private emitFrontendStandalone(): void {
    ...
    this.emit('// Auto-generated by Purp SCL Compiler v0.3.0 — Frontend Output');
  ...
  private emitHeader(): void {
    this.emit('// Auto-generated by Purp SCL Compiler v0.3.0');
    this.emit('// Do not edit manually');
    this.emit('');
